    ...
    <div className="w-full bg-white text-slate-900">
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto overflow-hidden">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[3rem] overflow-hidden relative shadow-2xl bg-slate-100 flex items-center justify-center">
              {founderData.image ? (
                <Image
                ...
                <div className="text-center p-8">
                  <Users className="w-24 h-24 text-slate-200 mx-auto mb-4" />
                  <span className="text-slate-400 font-bold uppercase tracking-widest text-xs">CEO - Visionary</span>
                </div>
              )}
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-32">
            {[
              { id: "executive", title: "Executive Leadership", members: teamMembers.filter(m => m.category === "Executive") },
              { id: "technology", title: "Technology & R&D", members: teamMembers.filter(m => m.category === "Technology") },
              { id: "operations", title: "HR & Management", members: teamMembers.filter(m => m.category === "Operations") },
              { id: "marketing", title: "Marketing & Growth", members: teamMembers.filter(m => m.category === "Marketing") },
              { id: "finance", title: "Finance & Performance", members: teamMembers.filter(m => m.category === "Finance") },
              { id: "engineering", title: "Web & Engineering", members: teamMembers.filter(m => m.category === "Engineering") },
              { id: "infrastructure", title: "Cloud & Infrastructure", members: teamMembers.filter(m => m.category === "Infrastructure") },
              { id: "coresystems", title: "Core Architecture", members: teamMembers.filter(m => m.category === "Core Systems") },
              { id: "creative", title: "Creative & Design", members: teamMembers.filter(m => m.category === "Creative") },
            ].filter(group => group.members.length > 0).map((group) => (
              <div key={group.id} className="space-y-12">
                <div className="flex items-center gap-6">
                  <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tighter">{group.title}</h3>
