  ...
  return (
    <div className=" p-8 bg-white shadow-lg rounded-xl">
      <div className=" flex items-center  justify-between">
        <div>
          <h2 className="text-2xl w-96 font-bold text-black  mb-6">
          ...
          <div className="flex justify-center mt-8 space-x-4">
            <button className="px-4 py-2 bg-white text-black border border-black rounded-3xl">
              More Questions
            </button>
            <button className="px-4 py-2  text-black  underline bg-white">
              Contact Us
            </button>
          </div>
        </div>
