...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {/* Navbar */}
            <motion.nav
                className={`fixed top-0 left-0 w-full px-4 py-4 hidden lg:flex justify-between items-center z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md py-3" : "bg-transparent"
                    } backdrop-blur-md`}>
                {/* Logo */}
                        ...
                        link.submenu ? (
                            <div
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1 text-lg font-medium transition duration-300 ${isScrolled
                            ...
                            <Link
                                key={link.id}
                                to={link.href}
                                className={`text-lg font-medium transition duration-300 ${isScrolled
                                        ? "text-gray-900 hover:text-teal-600 focus:text-teal-600"
                                        : "text-white hover:text-teal-400 focus:text-teal-400"
                                    } focus:outline-none`}
                                ...
                                link.submenu ? (
                                    <div key={link.id}>
                                        <button
                                            ...
                                            <Icons.ChevronDown
                                                size={18}
                                                className={`transform transition ${openDropdown === link.id ? "rotate-180" : ""
                                                    }`}
                                            />
                                        </button>
                                        <AnimatePresence>
