  ...
  return (
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-10">
        <div className="absolute top-1/4 left-1/3 w-80 h-80 bg-[var(--main-theme-color)] blur-3xl rounded-full"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-sm text-[var(--main-theme-color)] tracking-wider font-medium mb-2">
            WHY NEXFLOW
          </p>
