    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Elevate Your Digital Presence with Nexflow. We turn data into strategy, strategy into design, and design into growth."
                />
                <link rel="canonical" href="https://nexflow.tech/" />
            </Helmet>

            <div className="relative w-full md:h-screen h-[80vh] bg-black overflow-hidden md:pt-12 pt-20">
                {isMobile ? (
                    <div
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 md:px-20">
                    ...
                    <div className="max-w-5xl w-full md:mt-12 flex flex-col items-center text-center space-y-6">
                        <div className="mb-2">
                        ...
                        {/* ✅ Updated CTA Button with high contrast */}
                        <div className="mt-6">
                            <Link to="/Services">
                                <motion.button
                                    className="relative overflow-hidden bg-[#1F5F55] hover:bg-[#0D3B35] text-white font-semibold py-4 px-8 rounded-lg flex items-center gap-3 text-lg shadow-lg transition-colors"
                                >
                                    <span className="relative z-10 text-sm lg:text-md drop-shadow-md">
